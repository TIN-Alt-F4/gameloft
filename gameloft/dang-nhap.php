<?php 
	...
	if(isset($_POST['login']))
	{
		...
		if($email && $password)
		{
			...
			// check
			$sql = "SELECT email, level FROM account WHERE email = '$email' AND password = '$pass_md5' AND level = 2";
			...
			<div class="login_content">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="login_form">
								<span>Bạn quên mật khẩu à? Tốt nhất nên liên hệ administrator!!!</span>
								<form class="pt-5">
								  	<div class="form-group">
								    	<label for="exampleInputEmail1">Email* </label>
